...
namespace MHKCafe.Controllers
{
    public class mhkAdminsController : Controller
    {
        ...
        public mhkAdminsController(MhkcafeContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("AdminId,HoTen,Email,MatKhau,Quyen,NgayTao")] Admin admin)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("AdminId,HoTen,Email,MatKhau,Quyen,NgayTao")] Admin admin)
        {
            if (id != admin.AdminId)
            {
                return NotFound();
